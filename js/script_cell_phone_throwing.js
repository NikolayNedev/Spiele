...
function goScreen(element){
    ...
    if (numberThrows <= 0){
        ...
        switch (gravity) {
            case 9.81:
                document.body.style.backgroundImage = "url(\"../Games/images/ThrowYourPhone/earth_game_background01.jpg\")";
                break;
            case 1.62:
                document.body.style.backgroundImage = "url(\"../Games/images/ThrowYourPhone/moon_background.jpg\")";
            break;
            case 3.69:
                document.body.style.backgroundImage = "url(\"../Games/images/ThrowYourPhone/mars_game_background.jpg\")";
            break;
            case 24.79:
                document.body.style.backgroundImage = "url(\"../Games/images/ThrowYourPhone/Jupiter_game_background.jpg\")";
            break;
        }
    }
}
